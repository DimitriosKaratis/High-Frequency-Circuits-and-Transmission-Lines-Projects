...
maxGen = 5000;               % Maximum number of iterations
mini = [0.05 0.05 0.05 0.05 0.05 0.05];  % Lower Bound of Variables
maxi = 1*ones(1,var);        % Upper Bound of Variables
objective = @funct1_4e2;      % Cost Function
