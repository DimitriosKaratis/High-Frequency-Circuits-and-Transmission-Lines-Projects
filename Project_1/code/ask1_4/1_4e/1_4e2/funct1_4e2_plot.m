%% 1.4 (e2) Karatis Dimitrios 10775

function funct1_4e2_plot_Gamma = funct1_4e2_plot(p)
    ...
    ZL = 180 - 1i*200; % Τιμή φορτίου σε Ω
    ...
    funct1_4e2_plot_Gamma = mean(Gamma);
    ...
    title('MO του μέτρου συντελεστή ανάκλασης σε συνάρτηση με τη συχνότητα');
    grid on;
